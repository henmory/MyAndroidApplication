...
public class APIMethods {
    ...
    public static void getBookListByClass(Observer<BookBean> observer, String className, int start, int count){
        Map<String, String> map = new HashMap<>();
        map.put("tag", className);
        map.put("start", start + "");
        map.put("count", count + "");

        ApiSubscribe(API.getApiService().getBookClass(map),observer);
    }
}
